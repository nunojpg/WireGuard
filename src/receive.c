					...
					struct endpoint *endpoint)
{
	...
	/* Packet saddr comes always with the .0.1 address for every client
	...
	skb_checksum_setup(skb, true); //recalculate TCP/UDP pseudo header checksum
	ip_send_check(ip_hdr(skb)); //recalculate IP checksum
